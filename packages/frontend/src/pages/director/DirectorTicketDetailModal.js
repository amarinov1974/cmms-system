...
export function DirectorTicketDetailModal({ ticketId, onClose, }) {
    ...
    const canApprove = ticket.currentStatus === 'Cost Estimation Approval Needed' && isCurrentOwner;
